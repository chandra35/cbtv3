...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <form action="{{ route('admin.exams.update', $exam) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="jenjang" name="jenjang"
                            ...
                            required>
                            <option value="SD" {{ old('jenjang', $exam->jenjang) === 'SD' ? 'selected' : '' }}>SD (Elementary)</option>
                            <option value="SMP" {{ old('jenjang', $exam->jenjang) === 'SMP' ? 'selected' : '' }}>SMP (Junior High)</option>
                            <option value="SMA" {{ old('jenjang', $exam->jenjang) === 'SMA' ? 'selected' : '' }}>SMA (Senior High)</option>
                ...
                <div class="mt-6">
                    ...
                    <textarea id="description" name="description" 
                        ...
                        placeholder="Enter exam description" rows="4">{{ old('description', $exam->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div class="flex items-end">
                        <label class="flex items-center">
                            <input type="checkbox" name="show_answers_after" value="1" 
                                {{ old('show_answers_after', $exam->show_answers_after) ? 'checked' : '' }}
                    ...
                    <div class="flex items-end">
                        <label class="flex items-center">
                            <input type="checkbox" name="allow_review_before_submit" value="1"
                                {{ old('allow_review_before_submit', $exam->allow_review_before_submit) ? 'checked' : '' }}
                                class="h-4 w-4 text-blue-500 border-gray-300 rounded focus:ring-2 focus:ring-blue-500">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    ...
                    <div>
                        ...
                        <textarea id="passing_message" name="passing_message"
                            ...
                            rows="3">{{ old('passing_message', $exam->passing_message) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="failing_message" name="failing_message"
                            ...
                            rows="3">{{ old('failing_message', $exam->failing_message) }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="time" id="end_time" name="end_time" 
                            value="{{ old('end_time', $exam->end_time?->format('H:i')) }}"
